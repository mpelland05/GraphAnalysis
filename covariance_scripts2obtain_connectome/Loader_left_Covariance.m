...
%% Grabbing BASC
%%%%%%%%%%%%%%%%
files_in.networks.atoms = '/home/mpelland/database/blindtvr/fmri/region_growing_01_RestOnly_NoSmooth_NoLB_wholeLeft/rois/brain_rois.mnc.gz'; % <--------------------------------------------------------------------------modify according to desired value
...
%% Options 
%%%%%%%%%%%%
opt.folder_out = '/home/mpelland/database/blindtvr/results/glm_connectome_01_complete_WholeLeft_Covariance'; % Where to store the results
opt.fdr = 0.1; 
